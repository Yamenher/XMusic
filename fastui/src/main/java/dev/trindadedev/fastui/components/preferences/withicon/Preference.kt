...
constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
  ...
  init {
    ...
    preference = findViewById(R.id.root)
  ...
  fun setBackgroundType(type: Int) {
    val backgroundResource = when (type) {
        0 -> R.drawable.shape_top
        1 -> R.drawable.shape_middle
        2 -> R.drawable.shape_bottom
        3 -> R.drawable.shape_alone
        else -> Color.TRANSPARENT
    }
    preference.setBackgroundResource(backgroundResource)
}
}
